...
ALTER TABLE promotions ADD COLUMN IF NOT EXISTS badge_text VARCHAR(100);
...
-- Note: Use with caution if you have other data in these tables.
TRUNCATE TABLE categories, promotions, stores, collections, products RESTART IDENTITY CASCADE;


-- == CATEGORIES ==
-- Data from: src/components/category-grid.tsx
...
-- Data from: src/components/hero-section.tsx (mock placeholders)
INSERT INTO promotions (slug, title, subtitle, image_url, link_url, badge_text, position, is_active) VALUES
...
-- Data from: src/components/interlink-mall.tsx
INSERT INTO stores (slug, name, description, logo_url, banner_url, is_active) VALUES
...
INSERT INTO collections (slug, title, description, type, is_active) VALUES
...
-- == PRODUCTS & VARIANTS ==
-- This section combines data from product-grid.tsx and flash-sale.tsx

-- Product 1: Fiber Optic Cable
INSERT INTO products (slug, name, avg_rating, reviews_count, is_free_shipping)
VALUES ('fiber-optic-cable-sm-305m', 'Fiber Optic Cable Single Mode 305m', 4.8, 156, TRUE)
RETURNING id INTO a;
INSERT INTO product_variants (product_id, sku, price, compare_at_price) VALUES (a, 'P1-FOC-SM-305', 2150, 2750);
INSERT INTO product_images (product_id, url, position) VALUES (a, '/assets/fiber-optic-cable.jpg', 0);

-- Product 2: 24-Port Gigabit Network Switch
INSERT INTO products (slug, name, avg_rating, reviews_count, is_free_shipping)
VALUES ('24-port-gigabit-switch', '24-Port Gigabit Network Switch', 4.6, 234, TRUE)
RETURNING id INTO a;
INSERT INTO product_variants (product_id, sku, price, compare_at_price) VALUES (a, 'P2-SW-GIGA-24', 3890, 4500);
INSERT INTO product_images (product_id, url, position) VALUES (a, '/assets/network-switch-professional.jpg', 0);

-- Product 3: RG-6 Coaxial Cable
INSERT INTO products (slug, name, avg_rating, reviews_count, is_free_shipping)
VALUES ('rg6-coaxial-cable-305m', 'RG-6 Coaxial Cable 305m', 4.5, 189, FALSE)
RETURNING id INTO a;
INSERT INTO product_variants (product_id, sku, price, compare_at_price) VALUES (a, 'P3-COAX-RG6-305', 1450, 1850);
INSERT INTO product_images (product_id, url, position) VALUES (a, '/assets/coaxial-cable-reel.jpg', 0);

-- Product 4: Solar Cable
INSERT INTO products (slug, name, avg_rating, reviews_count, is_free_shipping)
VALUES ('solar-cable-4mm-100m', 'Solar Cable 4mm² PV Wire 100m', 4.7, 145, TRUE)
RETURNING id INTO a;
INSERT INTO product_variants (product_id, sku, price, compare_at_price) VALUES (a, 'P4-SOLAR-4MM-100', 2800, 3200);
INSERT INTO product_images (product_id, url, position) VALUES (a, '/assets/solar-cable-red.jpg', 0);

-- Product 5: Telephone Cable
INSERT INTO products (slug, name, avg_rating, reviews_count, is_free_shipping)
VALUES ('telephone-cable-4pair-305m', 'Telephone Cable 4-Pair Indoor 305m', 4.4, 98, FALSE)
RETURNING id INTO a;
INSERT INTO product_variants (product_id, sku, price, compare_at_price) VALUES (a, 'P5-TEL-4P-305', 980, 1250);
INSERT INTO product_images (product_id, url, position) VALUES (a, '/assets/telephone-cable.jpg', 0);

-- Product 6: Server Rack Cabinet
INSERT INTO products (slug, name, avg_rating, reviews_count, is_free_shipping)
VALUES ('server-rack-42u', '19" Server Rack Cabinet 42U', 4.9, 87, TRUE)
RETURNING id INTO a;
INSERT INTO product_variants (product_id, sku, price, compare_at_price) VALUES (a, 'P6-RACK-42U', 15800, 18500);
INSERT INTO product_images (product_id, url, position) VALUES (a, '/assets/server-rack-19inch.jpg', 0);

-- Product 7: US-9035 CAT 5E
INSERT INTO products (slug, name, avg_rating, reviews_count, is_free_shipping)
VALUES ('us-9035-cat5e-utp-305m', 'US-9035 CAT 5E UTP Cable Indoor 305m', 4.7, 178, FALSE)
RETURNING id INTO a;
INSERT INTO product_variants (product_id, sku, price, compare_at_price) VALUES (a, 'US-9035', 6094, 6800);
INSERT INTO product_images (product_id, url, position) VALUES (a, '/assets/lan-cat5e-box.jpg', 0);

-- Product 8: UT-0216 Fiber Media Converter
INSERT INTO products (slug, name, avg_rating, reviews_count, is_free_shipping)
VALUES ('ut-0216-media-converter', 'UT-0216 Fiber Media Converter RJ45', 4.6, 124, TRUE)
RETURNING id INTO a;
INSERT INTO product_variants (product_id, sku, price, compare_at_price) VALUES (a, 'UT-0216', 2247, 2800);
INSERT INTO product_images (product_id, url, position) VALUES (a, '/assets/fiber-media-converter.jpg', 0);
...
RETURNING id INTO a;
INSERT INTO product_variants (product_id, sku, price, compare_at_price) VALUES (a, 'FS1-PCI-ETH', 650, 1300);
INSERT INTO product_images (product_id, url, position) VALUES (a, '/assets/ethernet-pci-card.jpg', 0);
INSERT INTO collection_products (collection_id, product_id) VALUES ((SELECT id FROM collections WHERE slug = 'clearance-sale'), a);

-- Product 10: WiFi Router AC1200
INSERT INTO products (slug, name, avg_rating, reviews_count, is_free_shipping)
VALUES ('wifi-router-ac1200', 'WiFi Router AC1200 Dual Band', 4.7, 345, TRUE)
RETURNING id INTO a;
INSERT INTO product_variants (product_id, sku, price, compare_at_price) VALUES (a, 'FS2-WIFI-AC1200', 1490, 2980);
INSERT INTO product_images (product_id, url, position) VALUES (a, '/assets/wifi-router-ac1200.jpg', 0);
INSERT INTO collection_products (collection_id, product_id) VALUES ((SELECT id FROM collections WHERE slug = 'clearance-sale'), a);
...
RETURNING id INTO a;
INSERT INTO product_variants (product_id, sku, price, compare_at_price) VALUES (a, 'FS3-SW-MAN-24', 1945, 3890);
INSERT INTO product_images (product_id, url, position) VALUES (a, '/assets/switch-24port.jpg', 0);
INSERT INTO collection_products (collection_id, product_id) VALUES ((SELECT id FROM collections WHERE slug = 'clearance-sale'), a);
...
RETURNING id INTO a;
INSERT INTO product_variants (product_id, sku, price, compare_at_price) VALUES (a, 'FS4-CAT5E-LSZH', 1297, 2594);
INSERT INTO product_images (product_id, url, position) VALUES (a, '/assets/lan-cat5e-lszh.jpg', 0);
INSERT INTO collection_products (collection_id, product_id) VALUES ((SELECT id FROM collections WHERE slug = 'clearance-sale'), a);


-- == LINK PRODUCTS TO CATEGORIES (Example) ==
INSERT INTO product_categories (product_id, category_id) VALUES
((SELECT id FROM products WHERE slug = 'fiber-optic-cable-sm-305m'), (SELECT id FROM categories WHERE slug = 'fiber-optic')),
((SELECT id FROM products WHERE slug = 'rg6-coaxial-cable-305m'), (SELECT id FROM categories WHERE slug = 'coaxial')),
((SELECT id FROM products WHERE slug = 'us-9035-cat5e-utp-305m'), (SELECT id FROM categories WHERE slug = 'lan-utp')),
((SELECT id FROM products WHERE slug = '24-port-gigabit-switch'), (SELECT id FROM categories WHERE slug = 'networking'));

-- == LINK PRODUCTS TO "RECOMMENDED" COLLECTION ==
INSERT INTO collection_products (collection_id, product_id)
SELECT
    (SELECT id FROM collections WHERE slug = 'recommended-products'),
    p.id
FROM products p
WHERE p.slug IN (
